    ...
    protected void writeImpl(AionConnection con) {
        ...
        switch (mapId) {
            ...
            case 301310000: //Idgel Dome
                ...
                break;
      case 301400000:
                ShugoEmperorVaultReward shugoEmperorVaultReward = (ShugoEmperorVaultReward) instanceReward;
                writeD(shugoEmperorVaultReward.getPoints());
                writeD(shugoEmperorVaultReward.getPoints());
                writeD(0);
                writeD(shugoEmperorVaultReward.getRank());
                writeD(0);
                writeD(instanceScoreType.isEndProgress() ? 185000222 : 0);
                writeD(instanceScoreType.isEndProgress() ? shugoEmperorVaultReward.getKeys() : 0);
                writeD(0);
                writeD(0);
                writeD(0);
                writeD(0);
