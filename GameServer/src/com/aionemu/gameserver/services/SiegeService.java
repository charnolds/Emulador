...
public class SiegeService {
    ...
    public void initSieges() {
        ...
        CronService.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                if (moltenusAbyssBoss.containsKey(218553) && moltenusAbyssBoss.get(218553).isSpawned()) {
                    log.warn("Governor Sunayaka was already spawned...");
                } else {
                    int randomPos = Rnd.get(1, 3);
                    switch (randomPos) {
                        case 1:
                            moltenusAbyssBoss.put(218553, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(600040000, 218553, 759.0958f, 765.6816f, 1226.5004f, (byte) 0), 1));
                            moltenusAbyssBoss.put(283074, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(600040000, 283074, 754.84625f, 819.98828f, 1223.957f, (byte) 0), 1));
                            moltenusAbyssBoss.put(283076, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(600040000, 283076, 754.90234f, 712.99042f, 1223.957f, (byte) 0), 1));
                            break;
                        case 2:
                            moltenusAbyssBoss.put(218553, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(400010000, 218553, 759.0958f, 765.6816f, 1226.5004f, (byte) 0), 1));
                            moltenusAbyssBoss.put(283074, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(600040000, 283074, 754.84625f, 819.98828f, 1223.957f, (byte) 0), 1));
                            moltenusAbyssBoss.put(283076, SpawnEngine.spawnObject(SpawnEngine.addNewSingleTimeSpawn(600040000, 283076, 754.90234f, 712.99042f, 1223.957f, (byte) 0), 1));
                            break;
                        case 3:
                    ...
                    log.info("Sunayaka spawned in Tiamaranta eye");
                    World.getInstance().doOnAllPlayers(new Visitor<Player>() {
                        ...
                        public void visit(Player player) {
							...
							PacketSendUtility.sendSys2Message(player, "RaidBoss", "Governor Sunayaka ha aparecido in Tiamaranta Eye");
                        }
                    });
                            ...
                            for (VisibleObject vo : moltenusAbyssBoss.values()) {
                                ...
                                World.getInstance().doOnAllPlayers(new Visitor<Player>() {
                                    ...
                                    public void visit(Player player) {
										...
										PacketSendUtility.sendSys2Message(player, "RaidBoss", "Governor Sunayaka ha desaparecido");
                                    }
                                });
                            }
                        }
