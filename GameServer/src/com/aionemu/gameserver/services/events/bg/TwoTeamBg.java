            ...
            for (PlayerGroup group : super.getGroups()) {
                for (Player pl : group.getMembers()) {
					...
					if (level >= 10 && level <= 50) {
						ItemService.addItem(pl, 166030005, 5); //Tempering Solution.
						ItemService.addItem(pl, 166020000, 5); //Omega Enchantment Stone.
						ItemService.addItem(pl, 186000242, 3); //Enchantment Stone Dust.
						AbyssPointsService.addAp(pl, 500);
						AbyssPointsService.addGp(pl, 10);
					} if (level >= 51 && level <= 65) {
						ItemService.addItem(pl, 166030005, 7); //Tempering Solution.
						ItemService.addItem(pl, 166020000, 7); //Omega Enchantment Stone.
						ItemService.addItem(pl, 186000147, 5); //Enchantment Stone Dust.
						AbyssPointsService.addAp(pl, 1500);
						AbyssPointsService.addGp(pl, 20);
					} if (level >= 66 && level <= 83) {
						ItemService.addItem(pl, 166030005, 10); //Tempering Solution.
						ItemService.addItem(pl, 166020000, 10); //Omega Enchantment Stone.
						AbyssPointsService.addAp(pl, 2500);
						AbyssPointsService.addGp(pl, 30);
				    }
                }
            }
            super.specAnnounce("Draw!");
                ...
                if (group.getTeamId() == winner.getTeamId()) {
                    ...
                    for (Player pl : group.getMembers()) {
						...
						if (level >= 10 && level <= 50) {
							...
							ItemService.addItem(pl, 186000242, 1); //Enchantment Stone Dust.
							AbyssPointsService.addAp(pl, 500);
							AbyssPointsService.addGp(pl, 5);
						} if (level >= 51 && level <= 65) {
							ItemService.addItem(pl, 166030005, 3); //Tempering Solution.
							ItemService.addItem(pl, 166020000, 3); //Omega Enchantment Stone.
							ItemService.addItem(pl, 186000147, 3); //Enchantment Stone Dust.
							AbyssPointsService.addAp(pl, 1500);
