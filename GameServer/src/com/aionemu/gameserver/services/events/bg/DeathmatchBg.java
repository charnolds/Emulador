...
public class DeathmatchBg extends Battleground
{
    public DeathmatchBg() {
		...
		map9.setKillZ(380f);
        super.maps.add(map9);
		//Grave Of Steel Storeroom. kysis chamber
		...
		//Twilight Battlefield Storeroom.//miren
		...
		//Isle Of Roots Storeroom.//krotan
