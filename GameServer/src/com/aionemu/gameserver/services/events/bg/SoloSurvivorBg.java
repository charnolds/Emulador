        ...
        if (winner == null) {
			for (Player pl : super.getPlayers()) {
				...
				if (level >= 66 && level <= 83) {
					ItemService.addItem(pl, 166030005, 15); //Tempering Solution.
					ItemService.addItem(pl, 166020000, 15); //Omega Enchantment Stone.
					ItemService.addItem(pl, 186000242, 7); //Enchantment Stone Dust.
