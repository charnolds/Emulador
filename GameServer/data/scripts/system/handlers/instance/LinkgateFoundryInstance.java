	 ...
	 public void onDropRegistered(Npc npc) {
	     ...
	     switch (npcId) {
	        case 233887: // Key Keeper
				...
				dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 166020000, 8));
				dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 166030005, 8));
	            break;
			case 233898: //Volatile Belsagos.
				...
				dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 166020000, 16));
				dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 166030005, 16));
				break;
			...
			case 234991: //Furious Belsagos.
				...
				dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 166020000, 50));
				dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 166030005, 30));
				break;
