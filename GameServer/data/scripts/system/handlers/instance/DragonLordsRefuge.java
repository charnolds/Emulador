			...
			case 701542: //Tiamat's Huge Treasure Crate.
				...
				for (Player player: instance.getPlayersInside()) {
				    if (player.isOnline()) {
						...
						dropItems.add(DropRegistrationService.getInstance().regDropItem(index++, player.getObjectId(), npcId, 166020000, 50)); //Omega enchants.
						dropItems.add(DropRegistrationService.getInstance().regDropItem(index++, player.getObjectId(), npcId, 186000242, 12)); //ceranium medal.
					    dropItems.add(DropRegistrationService.getInstance().regDropItem(index++, player.getObjectId(), npcId, 166030005, 20)); //serum.
						dropItems.add(DropRegistrationService.getInstance().regDropItem(index++, player.getObjectId(), npcId, 188052070, 1)); //[Event] Fabled Godstone Bundle
				        dropItems.add(DropRegistrationService.getInstance().regDropItem(index++, player.getObjectId(), npcId, 186000051, 30)); //Major Ancient Crown.
				        dropItems.add(DropRegistrationService.getInstance().regDropItem(index++, player.getObjectId(), npcId, 186000052, 30)); //Greater Ancient Crown.
				        dropItems.add(DropRegistrationService.getInstance().regDropItem(index++, player.getObjectId(), npcId, 186000236, 50)); //Blood Mark.
				        dropItems.add(DropRegistrationService.getInstance().regDropItem(index++, player.getObjectId(), npcId, 186000237, 50)); //Ancient Coin.
