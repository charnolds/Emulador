    ...
    public void doReward(Player player) {
        ...
        switch (rank) {
            ...
            case 4: // C
				...
				instanceReward.setBasicGP(2000);
                //instanceReward.setSmallBundleWater(1);
                break;
            case 5: // D
			    instanceReward.setBasicGP(1000);
		...
		AbyssPointsService.addAp(player, instanceReward.getBasicGP());
        ...
        ItemService.addItem(player, 188053131, instanceReward.getSmallBundleWater());
    }
