...
public class OneVsOne extends PlayerCommand {
    ...
    public void execute(Player player, String...params){ // remember to put IF in group the player auto leaves .. this part need to be down on the event registarer or porter...
		...
		if (player.getAbyssRank().getRank().getId() == G1){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
		}
		if (player.getAbyssRank().getRank().getId() == G2){
           PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
		   return;
		}
		if (player.getAbyssRank().getRank().getId() == G3){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
		}
		if (player.getAbyssRank().getRank().getId() == G4){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
		}
		if (player.getAbyssRank().getRank().getId() == G5){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
		}
		if (player.getAbyssRank().getRank().getId() == G6){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
		}
		if (player.getAbyssRank().getRank().getId() == G7){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
		}
		if (player.getAbyssRank().getRank().getId() == G8){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
		}
		if (player.getAbyssRank().getRank().getId() == G9){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
		}
		if (player.getAbyssRank().getRank().getId() == OFCR1){
            PacketSendUtility.sendMessage(player, "Necesitas Rank: Army Star Oficcer 2 Para entrar al 1v1");
			return;
         }
