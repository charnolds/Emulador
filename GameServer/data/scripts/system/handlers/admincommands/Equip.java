    ...
    public void execute(Player admin, String... params) {
        if (params.length != 0) {
            ...
            if ("help".startsWith(params[i])) {
                ...
                } else if ("enchantt".startsWith(params[i + 1])) {
                    showHelpEnchant(admin);
                } else if ("godstonee".startsWith(params[i + 1])) {
                    showHelpGodstone(admin);
                } else if ("temperingg".startsWith(params[i + 1])) {
                    showHelpTempering(admin);
                } else if ("amplifyy".startsWith(params[i + 1])) {
