 ...
 * @modified Wasacacax
 */
@AIName("ide_pool") //231104
public class IdePoolAI2 extends NpcAI2 {
    ...
    private void checkDistance(NpcAI2 ai, Creature creature) {
        if (creature instanceof Player && !creature.getLifeStats().isAlreadyDead()) {
        	if (MathUtil.isInAnnulus(creature, new Point3D(127.99812f, 137.83086f, 112.1743f), 14.0f, 0.01f)) {
	    		if (creature.getZ() < 112.2) {
