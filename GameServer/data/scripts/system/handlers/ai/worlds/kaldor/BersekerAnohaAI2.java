 ...
 */
@AIName("anoha")
public class BersekerAnohaAI2 extends AggressiveNpcAI2 {
    ...
    private void UnderAttackNotice() {
        World.getInstance().doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player player) {
                PacketSendUtility.sendBrightYellowMessageOnCenter(player, "Berseker Anoha is under atack on kaldor!");
            }
        });
    }
    private void UnderAttackNotice2() {
        World.getInstance().doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player player) {
                PacketSendUtility.sendBrightYellowMessageOnCenter(player, "Berseker Anoha is almost died!");
            }
        });
    }
    @Override
    protected void handleDied() {
        ...
        World.getInstance().doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player player) {
                PacketSendUtility.sendBrightYellowMessageOnCenter(player, "Berseker Anoha was Killed!");
            }
        });
    }
}
